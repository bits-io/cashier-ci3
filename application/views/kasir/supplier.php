...
<body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($read as $d) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d->nama?></span></td>
                                                    <td class="text-center"><?= $d->no_hp ?></span></td>
                                                    <td><?= $d->alamat ?></td>
                        ...
                        <span id="modal-body-update-or-create">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="alamat" class="form-control" onkeyup="convertToRupiah(this);" onchange="return total()">
                                </div>
                            </div>
                        </span>
    ...
    <script>
        ...
        function tambah() {
            ...
            $('[name="no_hp"]').val("");
            $('[name="alamat"]').val("");
            document.form.action = '<?= base_url(); ?>admin/tambah_supplier';
        };

        function ubah(id, nama, no_hp, alamat) {
            $('#Modal').modal('show');
            ...
            document.form.action = '<?= base_url(); ?>admin/ubah_supplier';
        };

        function hapus(id, nama, no_hp, alamat) {
            $('#Modal').modal('show');
            ...
            document.form.action = '<?= base_url(); ?>admin/hapus_supplier';
        };
    </script>
</body>
