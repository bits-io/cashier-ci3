...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        ...
        function tambah() {
            ...
            $('[name="no_hp"]').val("");
            $('[name="alamat"]').val("");
            document.form.action = '<?= base_url(); ?>admin/tambah_owner';
        };
        ...
        function ubah(id, nama_owner, no_hp, alamat) {
            ...
            document.form.action = '<?= base_url(); ?>admin/ubah_owner';
        };

        function hapus(id, nama_owner, no_hp, alamat) {
            $('#Modal').modal('show');
            ...
            document.form.action = '<?= base_url(); ?>admin/hapus_owner';
        };
    </script>
</body>
